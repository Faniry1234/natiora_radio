-- ============================================
-- BASE DE DONNÉES NATIORA RADIO 98.2 (Import pour Laragon / MySQL)
-- ============================================

-- Créer la base de données si elle n'existe pas et la sélectionner
...
-- ============================================
-- INSERTION DES DONNÉES (désactiver temporairement les clés étrangères pour reorder/clear)
-- ============================================
...
-- Réactiver la vérification des clés étrangères si nécessaire (sécurisé)
